...
async function main(){
    ...
    const myKeypair = loadWalletKey("SPX2rneipCdCuYY1n9mbv9FB4QVa31nhA9XZnSSi3nG.json");
    const mint = new web3.PublicKey("TsJqdNkUKPAu8b98UfhRcwYW7gGdy2hCsTeizhEUrPT");
